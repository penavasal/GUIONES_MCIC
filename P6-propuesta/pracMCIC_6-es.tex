...
\author{José M.ª Goicolea, Ángel Yagüe, Pedro Navas\\
        {\small\sc 
...
\section{Geometría y elementos comunes}
\label{sec:guia}
...
\caption{Extrusión del pilar, con Longitud $z=L=50$ metros y ángulo de desvío de -1.1458$^o$.}
\label{fig:extru}
\end{figure}

Antes de pasar al siguiente módulo vamos a definir un punto de referencia de esta geometría, que será donde irá ubicada la cabeza del aerogenerador. Selccionamos Tools\ Reference Point, Fig. \ref{fig:3}.a, y buscamos el punto medio de la sección superior del fuste, Fig. \ref{fig:3}.b. Una vez seleccionado, el punto de referencia queda como en la figura \ref{fig:3}.c
...
\subfigure[Simetría XSYMM creada]{\includegraphics[scale=0.25]{capturas/26-load-x.png}}
...
\subfigure[Simetría ZSYMM creada]{\includegraphics[scale=0.25]{capturas/27b-load-x.png}}
