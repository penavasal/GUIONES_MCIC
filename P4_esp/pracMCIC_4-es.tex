...
\begin{figure}[h!tp]
\centering
\subfigure[Crear nueva parte]{\includegraphics[scale=0.4]{capturas/02-partx.png}}
...
\subfigure[definir extrusión]{\includegraphics[scale=0.5]{capturas/06-partx.png}}
...
\subfigure[tipo de material y propiedades]{\includegraphics[scale=0.50]{capturas/09-property-x.png}}
